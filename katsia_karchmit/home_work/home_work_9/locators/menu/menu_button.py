...
class MainPage(WebPage):
    ...
    text_completed_projects = WebElement(xpath="//div[contains(concat(' ', normalize-space(@class), ' '), ' section__header-title ')]")
    ...
    text_LEV_APARTMENT = WebElement(xpath="//h1[text()='LEV APARTMENT']")
    ...
    text_contacts_ZROBIM_architects = WebElement(xpath="//h1[contains(concat(' ', normalize-space(@class), ' '), ' section__header-title ')]")
    ...
    send_button = WebElement(xpath='(//button[@type="submit"])[1]')
    text_thank_appeal = WebElement(xpath="//div[contains(concat(' ', normalize-space(@class), ' '), ' section__content ')]//h1")
    home_return_button = WebElement(xpath="//*[@href='/' and text()='Вернуться на главную']")
