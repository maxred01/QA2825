...
async def api(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = await execute_command(
        "pytest -s -v home_work/home_work_6/pom_site/test/api/ --alluredir=./allure-results",
        update
    )
...
async def ui(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Запуск pytest
    result = await execute_command(
        "pytest -s -v home_work/home_work_6/pom_site/test/ui/ --alluredir=./allure-results",
        update
    )
...
async def all_tests(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Запуск pytest
    result = await execute_command(
        "pytest -s -v home_work/home_work_6/pom_site/test --alluredir=./allure-results",
        update
    )
